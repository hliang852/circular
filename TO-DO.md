...
- [ ] **Trigger full universe build** — run `python scripts/build_universe.py` (or trigger `update_universe.yml` via GitHub Actions workflow_dispatch). This expands from 10 seed stocks to ~600–900 stocks above $100M USD market cap.
